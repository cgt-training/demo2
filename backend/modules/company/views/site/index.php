                                                ...
                                                <table class="table">
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <div class="flag">
                                                                     ...
                                                                     <?= Html::img('@web/images/flags/US.png'); ?>
                                                                </div>
                                                            </td>
                                                            <td>USA</td>
                                                            <td class="text-right">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="flag">
                                                                    <?= Html::img('@web/images/flags/DE.png'); ?>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="flag">
                                                                     <?= Html::img('@web/images/flags/AU.png'); ?>
                    ...
                    <div class="row">
                            ...
                            <div class="card card-product">
                                <div class="card-image" data-header-animation="true">
                                    <a href="#pablo">
                                        ...
                                        <?= Html::img('@web/images/card-2.jpg'); ?>
                                    </a>
                                </div>
                                <div class="card-content">
                                    <div class="card-actions">
                        ...
                        <div class="col-md-4">
                            <div class="card card-product">
                                <div class="card-image" data-header-animation="true">
                                    <a href="#pablo">
                                        <?= Html::img('@web/images/card-3.jpg'); ?>
                        ...
                        <div class="col-md-4">
                            <div class="card card-product">
                                <div class="card-image" data-header-animation="true">
                                    <a href="#pablo">
                                         <?= Html::img('@web/images/card-1.jpg'); ?>
